        ...
        <div class="space-y-2">
          <div v-for="(item, i) in category_data" :key="`category-${i}`" class="pl-4">
            ...
            <div v-for="(curriculum_item, j) in item['curriculums']" :key="`curriculum-${j}`" class="mt-2 pl-6 hover:bg-sky-100">
              <NuxtLink v-if="curriculum_item.authority_ranks==0" :to="`/curriculums/${curriculum_item.curriculum_slug}`" class="block text-2xl text-gray-400 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">
