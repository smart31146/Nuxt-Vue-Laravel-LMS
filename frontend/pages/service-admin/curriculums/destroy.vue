<template>
  ...
  <section>
    <div class="nav-area" :class="{ 'is_open': store.state.stateIsMenuOpen }">
      <nav class="gnav">
        <ul class="gnav-list">
          ...
          <li class="gnav-item">
            <NuxtLink class="gnav-link" to="/service-admin/curriculums"
    ...
    <div class="content">
      <h1 class="result sec-title account-title">カリキュラムの削除完了</h1>
      <p class="result inner-text">カリキュラムの削除が完了しました。</p>
    </div>
  </section>
</template>
