<template>
  ...
  <section>
    <div class="nav-area" :class="{ 'is_open': store.state.stateIsMenuOpen }">
      <nav class="gnav">
        <ul class="gnav-list">
          ...
          <li class="gnav-item">
            <NuxtLink class="gnav-link" to="/service-admin/dashboard"
              >ホームに戻る</NuxtLink
            >
          </li>
        </ul>
    ...
    <div class="content">
      <h1 class="result sec-title account-title">修了証の発行完了</h1>
      <p class="result inner-text">修了証の発行が完了しました。</p>
    </div>
  </section>
</template>
