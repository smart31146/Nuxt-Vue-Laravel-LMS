<template>
  ...
  <section>
    <div class="nav-area" :class="{ 'is_open': store.state.stateIsMenuOpen }">
      <nav class="gnav">
        <ul class="gnav-list">
          ...
          <li class="gnav-item">
            <NuxtLink class="gnav-link" to="/service-admin/categories"
              >カテゴリ管理に戻る</NuxtLink
            >
          </li>
        </ul>
    ...
    <div class="content">
      <h1 class="result sec-title account-title">カテゴリの作成完了</h1>
      <p class="result inner-text">カテゴリの作成が完了しました。</p>
    </div>
  </section>
</template>
