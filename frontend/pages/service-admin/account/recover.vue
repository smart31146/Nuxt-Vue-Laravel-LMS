<template>
  ...
  <section>
    <div class="nav-area" :class="{ 'is_open': store.state.stateIsMenuOpen }">
      <nav class="gnav">
        <ul class="gnav-list">
          ...
          <li class="gnav-item">
            <NuxtLink class="gnav-link" to="/service-admin/account"
    ...
    <div class="content">
      <h1 class="result sec-title account-title">管理者アカウントの復帰完了</h1>
      <p class="result inner-text">管理者アカウントの復帰が完了しました。</p>
    </div>
  </section>
</template>
