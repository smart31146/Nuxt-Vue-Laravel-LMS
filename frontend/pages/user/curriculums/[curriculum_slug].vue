    ...
    <div class="mt-60 m-auto">
          ...
          <section class="category table-page">
            <form class="form curriculum-form">
             ...
             <NuxtLink to="/user/dashboard" class="u-text-decoration--underline"> <button class="m-auto w-full md:w-1/4 text-2xl py-4 mb-4 flex justify-center text-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">カリキュラム一覧に戻る</button></NuxtLink>
              <NuxtLink to="/user/curriculums" class="u-text-decoration--underline"><button class="m-auto w-full md:w-1/4 text-2xl py-4 mb-4 flex justify-center text-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">受講履歴に戻る</button></NuxtLink>
