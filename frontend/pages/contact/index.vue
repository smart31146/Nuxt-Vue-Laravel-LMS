...
<section class="mt-48 py-3">
    <div class="my-6">
        <div class="max-w-6xl mx-auto max-w-6xl mx-auto bg-purple-600 bg-opacity-100 rounded-lg rounded-lg">
            <div class="grid md:grid-cols-2 items-center gap-16 sm:p-10 p-4 font-[sans-serif]">
                <div>
                    <h1 class="text-4xl font-extrabold text-white">お問い合わせ</h1>
                    <p class="text-sm text-white mt-3">私たちの教育システムを利用するのに助けが必要ですか？ ご意見をお聞きし、お手伝いさせていただきます。</p>
                    <ul class="mt-12 space-y-8">
                        <li class="flex items-center">
                            ...
                            <a href="#" class="text-white text-sm ml-3">
                ...
                <div class="bg-gray-200 p-12 rounded-lg">
                    ...
                    <form class="mt-8 space-y-4">
                        <input type='text' placeholder='お名前' v-model="your_name"
                            class="w-full bg-white rounded-md py-3 px-4 text-sm outline-[#a91079]" />
                        <input type='email' placeholder='Email' v-model="your_email"
                            class="w-full bg-white rounded-md py-3 px-4 text-sm outline-[#a91079]" />
                        
                        <textarea placeholder='本文' rows="6" v-model="your_body"
                            class="w-full bg-white rounded-md px-4 text-sm pt-3 outline-[#a91079]"></textarea>
                        <button type='button' 
                            class="text-white bg-pink-800 hover:bg-[#a91079e2] font-semibold rounded-md text-sm px-4 py-3 flex items-center justify-center w-full" @click.prevent="submit">
